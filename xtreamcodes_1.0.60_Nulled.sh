...
echo -e "${jeshile} ┌───────────────────────────┐ \e[0m"
echo -e "${jeshile} │Checando Versão do Sistema │ \e[0m"
echo -e "${jeshile} └───────────────────────────┘ \e[0m"
sleep 3
echo -e "${jeshile} ┌───────────────────────────┐ \e[0m"
echo -e "${jeshile} │   Detectado sistema $os   │ \e[0m"
echo -e "${jeshile} └───────────────────────────┘ \e[0m"
sleep 3
echo -e "${jeshile} ┌───────────────────────────┐ \e[0m"
echo -e "${jeshile} │   Instalando Servidor Web │ \e[0m"
echo -e "${jeshile} └───────────────────────────┘ \e[0m"
echo " "
...
sudo apt-get update
sudo apt-get install php5.6-dev php5-gd -y
apt-get install php5.6-geoip php5.6-fpm mcrypt php5.6-mcrypt mcrypt -y
...
echo " "
echo -e "${jeshile} ┌─────────────────────────────────┐ \e[0m"
echo -e "${jeshile} │    Bloqueando redirecionamento  │ \e[0m"
echo -e "${jeshile} └─────────────────────────────────┘ \e[0m"
echo " "
...
echo " "
echo -e "${jeshile} ┌─────────────────────────────┐ \e[0m"
echo -e "${jeshile} │   Bloqueando conexão SSH    │ \e[0m"
echo -e "${jeshile} └─────────────────────────────┘ \e[0m"
echo " "
...
echo " "
echo -e "${jeshile} ┌─────────────────────────────┐ \e[0m"
echo -e "${jeshile} │   Bloqueando conexão FTP    │ \e[0m"
echo -e "${jeshile} └─────────────────────────────┘ \e[0m"
echo " "
...
echo " "
echo -e "${jeshile} ┌─────────────────────┐ \e[0m"
echo -e "${jeshile} │  Bloqueando TUNTAP  │ \e[0m"
echo -e "${jeshile} └─────────────────────┘ \e[0m"
echo " "
...
echo " "
echo -e "${jeshile} ┌────────────────────────────────────────────┐ \e[0m"
echo -e "${jeshile} │     Instalando tabelas de IP e OpenVPN     │ \e[0m"
echo -e "${jeshile} └────────────────────────────────────────────┘ \e[0m"
echo " "
sudo apt-get install iptables-persistent && apt-get install openvpn -y
echo " "
echo -e "${jeshile} ┌──────────────────────────────────────────┐ \e[0m"
echo -e "${jeshile} │     Baixando, Extraindo e Instalando     │ \e[0m"
echo -e "${jeshile} └──────────────────────────────────────────┘ \e[0m"
echo " "
#mkdir /var/www/html
...
echo -e "${jeshile} ┌─────────────────────────────────────────┐ \e[0m"
echo -e "${jeshile} │   Substituindo original por crackeado   │ \e[0m"
echo -e "${jeshile} └─────────────────────────────────────────┘ \e[0m"
echo " "
...
echo -e "${jeshile} ┌──────────────────────────────┐ \e[0m"
echo -e "${jeshile} │      CONFIGURANDO MYSQL      │ \e[0m"
echo -e "${jeshile} └──────────────────────────────┘ \e[0m"
echo " "
...
echo " "
echo -e "${jeshile} ┌──────────────────────────────────┐ \e[0m"
echo -e "${jeshile} │  REMOVENDO ARQUIVOS TEMPORARIOS  │ \e[0m"
echo -e "${jeshile} └──────────────────────────────────┘ \e[0m"
echo " "
...
echo -e "${jeshile} └──────────────────────────────────────────────────────────┘ \e[0m"
echo -e "${jeshile} ┌──────────────────────────────────────────────────────────┐ \e[0m"
echo -e "${jeshile} │[+]                 Recoded by 3sid3s                     │ \e[0m"
echo -e "${jeshile} └──────────────────────────────────────────────────────────┘ \e[0m"
echo " "
sleep 8
reboot
echo " "
echo -e "${jeshile} ┌───────────────────────┐ \e[0m"
echo -e "${jeshile} │[R]Reiniciando VPS...  │ \e[0m"
echo -e "${jeshile} └───────────────────────┘ \e[0m"
echo " "